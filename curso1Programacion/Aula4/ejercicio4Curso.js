...
console.log('Bienvenido a BCAH. Continua con nosotros, por favor');
let nombre = 'Camilo alarcon';
...
console.log(`La resta de ${valor1} menos ${valor2} es igual a ${resultadoResta}`);
